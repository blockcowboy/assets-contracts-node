...
use pallet_contracts::runtime_decl_for_contracts_api::ContractsApi;
...
/* 
impl ContractsApi<Block, AccountId, Balance, BlockNumber, Hash, EventRecord> for Runtime {
    fn call(
        origin: AccountId,
        dest: AccountId,
        value: Balance,
...
construct_runtime!(
    pub enum Runtime
    {
        ...
        RandomnessCollectiveFlip: pallet_insecure_randomness_collective_flip::{Pallet, Storage} = 52,
        Contracts: pallet_contracts::{Pallet, Call, Storage, Event<T>} = 53,
    }
);
